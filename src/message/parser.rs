...
fn validate_callsign_basic(callsign: &str) -> Result<(), String> {
...
fn is_nonstandard_callsign(callsign: &str) -> bool {
...
fn validate_grid_basic(grid_or_report: &str) -> Result<(), String> {
