...
///
/// Validates that a callsign is alphanumeric and within length limits.
/// Supports hash callsigns (angle brackets) and /R or /P suffixes.
pub(super) fn validate_callsign_basic(callsign: &str) -> Result<(), String> {
...
pub(super) fn is_nonstandard_callsign(callsign: &str) -> bool {
...
/// - Special codes: RRR, RR73, 73, or empty string
pub(super) fn validate_grid_basic(grid_or_report: &str) -> Result<(), String> {
